...
import { Route, ParamListBase, NavigationProp, Descriptor, NavigationHelpers, DrawerNavigationState, DrawerActionHelpers, RouteProp } from '@react-navigation/native';
...
export declare type DrawerNavigationConfig<T = DrawerContentOptions> = {
    /**
...
export declare type DrawerNavigationOptions = {
    /**
...
export declare type DrawerContentComponentProps<T = DrawerContentOptions> = T & {
...
export declare type DrawerContentOptions = {
    /**
...
export declare type DrawerNavigationProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = NavigationProp<ParamList, RouteName, DrawerNavigationState, DrawerNavigationOptions, DrawerNavigationEventMap> & DrawerActionHelpers<ParamList>;
export declare type DrawerScreenProps<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = {
    navigation: DrawerNavigationProp<ParamList, RouteName>;
    route: RouteProp<ParamList, RouteName>;
};
export declare type DrawerDescriptor = Descriptor<ParamListBase, string, DrawerNavigationState, DrawerNavigationOptions>;
export declare type DrawerDescriptorMap = {
