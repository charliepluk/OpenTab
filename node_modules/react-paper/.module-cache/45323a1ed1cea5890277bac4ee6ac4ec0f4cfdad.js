...
var Ripple = React.createClass({displayName: 'Ripple',
  ...
  downAction: function(e) {
    ...
    if (e.target.classList.contains("recenteringTouch")) {
  ...
  render: function() {
    return (
      React.DOM.div( {onMouseDown:this.downAction, onMouseUp:this.upAction, style:this.stretchStyle, className:"ripple"}, 
        React.DOM.div( {style:this.stretchStyle, ref:"bg"}),
        React.DOM.div( {style:this.stretchStyle, ref:"waves"})
      )
    );
  },
  ...
  createWave: function(elem) {
    var elementStyle = window.getComputedStyle(elem);
    var fgColor = elementStyle.color;

    var inner = document.createElement('div');
    inner.style.backgroundColor = fgColor;
    Object.keys(this.stretchStyle).forEach(function(key) {
      inner.style[key] = this.stretchStyle[key];
    });
    Object.keys(this.overflowStyle).forEach(function(key) {
      inner.style[key] = this.overflowStyle[key];
    });
    Object.keys(this.borderStyle).forEach(function(key) {
      inner.style[key] = this.borderStyle[key];
    });
    Object.keys(this.opacityStyle).forEach(function(key) {
      inner.style[key] = this.opacityStyle[key];
    });
    ...
    Object.keys(this.stretchStyle).forEach(function(key) {
      outer.style[key] = this.stretchStyle[key];
    });
    Object.keys(this.overflowStyle).forEach(function(key) {
      outer.style[key] = this.overflowStyle[key];
    });
  ...
  removeWaveFromScope: function(scope, wave) {
    if (scope.waves) {
