...
\
  .ripple, .bg, .waves, .wave-container, .wave {\
    pointer-events: none;\
    position: absolute;\
    top: 0;\
    left: 0;\
...
var Ripple = React.createClass({displayName: 'Ripple',
  ...
  render: function() {
    /*
      <div onMouseDown={this.downAction} onMouseUp={this.upAction} onMouseLeave={this.upAction} style={this.stretchStyleCapture} className="ripple">
        <div className="bg" style={this.stretchStyle} ref="bg"></div>
        <div className="waves" style={this.stretchStyle} ref="waves"></div>
      </div>
    */
    return (
  ...
  createWave: function(elem) {
    ...
    /*Object.keys(this.waveStyle).forEach(function(key) {
      inner.style[key] = this.waveStyle[key];
    }.bind(this));*/

    inner.classList.add('wave');

    var outer = document.createElement('div');
    /*Object.keys(this.waveContainerStyle).forEach(function(key) {
      outer.style[key] = this.waveContainerStyle[key];
    }.bind(this));*/
