...
var Slider = React.createClass({displayName: 'Slider',
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:containerClass}, 
        React.DOM.div( {ref:"barContainer", onClick:this.handleBarClick.bind(null, true), className:"bar-container"}, 
          Progress( {max:max, value:value} )
        ),
        React.DOM.div( {onDrag:this.draggy, onMouseDown:this.expandKnob, style:{left: value + '%'}, className:"slider-knob"}, 
  ...
  handleBarClick: function(evt, transition) {
    console.log('triggy', transition);
