...
var Slider = React.createClass({displayName: 'Slider',
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:containerClass}, 
        React.DOM.div( {onClick:this.handleBarClick, className:"bar-container"}, 
          Progress( {max:max, value:value} )
        ),
        React.DOM.div( {onMouseDown:this.expandKnob, style:{left: value + '%'}, className:"slider-knob"}, 
  ...
  handleBarClick: function(evt) {
    console.log(evt, evt.clientX, evt.pageX, evt.screenX, evt.target.getBoundingClientRect());
    this.setState({transiting: true});
