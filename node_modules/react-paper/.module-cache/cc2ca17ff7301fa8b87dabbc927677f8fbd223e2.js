...
var Ripple = React.createClass({displayName: 'Ripple',
  ...
  render: function() {
    return (
      React.DOM.div( {onMouseDown:this.downAction, onMouseUp:this.upAction, onMouseLeave:this.upAction, style:this.stretchStyleCapture, className:"ripple"}, 
        React.DOM.div( {className:"bg", style:this.stretchStyle, ref:"bg"}),
        React.DOM.div( {className:"waves", style:this.stretchStyle, ref:"waves"})
      )
    );
  },
